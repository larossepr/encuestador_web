...
with form.form(key=f"encuesta_form_{st.session_state.form_id}"):
    ...
    lugares_ocio = st.multiselect("Lugares que visita la gente visita en la comunidad para divertirse", ocio, placeholder="Elija uno o mas lugares")
    orgs = ["Iglesia", "Grupo Deportivo", "Club", "Asociacion de Agricultores", "Asociacion de Comerciantes", "Asociacion de Ganaderos", "Otra"]
    organizacion = st.multiselect("Organizaciones a las que pertenece", orgs, placeholder="Elija una o mas organizaciones")
